...
export default function Home() {
  ...
  // Keep the original homepage content for direct access via /home
  ...
  return (
    <div className="min-h-screen bg-stone-50">
        ...
        <div className="container-luxury">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed">
              Carefully selected crystals with exceptional energy and beauty. 
              Each stone is unique and carries its own story.
            </p>
          </div>
      ...
      {/* Benefits Section - Gaia Crystal Style */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group animate-fade-in" style={{animationDelay: '0.2s'}}>
              ...
              <p className="text-stone-600 leading-relaxed">
                Hand-selected crystals from trusted sources around the world, 
                ensuring authenticity and high energy vibrations.
              </p>
            </div>
            ...
            <div className="text-center group animate-fade-in" style={{animationDelay: '0.4s'}}>
              ...
              <p className="text-stone-600 leading-relaxed">
                Free shipping on orders over $100. Secure packaging 
                to protect your precious stones during transit.
              </p>
            </div>
            ...
            <div className="text-center group animate-fade-in" style={{animationDelay: '0.6s'}}>
              ...
              <p className="text-stone-600 leading-relaxed">
                Our crystal experts will help you find the perfect stones 
                for your spiritual journey and healing needs.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Sign up for our <span className="text-amber-600 font-medium">VIP crystal club</span> and get access 
                  to all news and discounts.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="aspect-[4/5] lg:aspect-[3/4] bg-gradient-to-br from-stone-100 to-stone-200 rounded-lg overflow-hidden">
                {/* Placeholder image with lifestyle elements */}
